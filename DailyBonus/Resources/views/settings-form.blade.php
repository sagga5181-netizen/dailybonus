<div class="daily-bonus-settings">
    <div class="settings-layout">
        <div class="settings-nav">
            <div class="nav flex-column" id="settingsTabs">
                ...
                <button class="nav-link" data-tab="display">
                ...
                <button class="nav-link" data-tab="preview">
        ...
        <div class="settings-content">
            ...
            <div class="settings-tab active" id="tab-general">
                ...
                <div class="alert alert-info">За цикл из <strong>{{ $settings['days_count'] ?? 7 }}</strong> дней пользователь получит <strong class="text-success">{{ ($settings['bonus_amount'] ?? 100) * ($settings['days_count'] ?? 7) }} ₽</strong></div>
            </div>

            <!-- Награды -->
            <div class="settings-tab" id="tab-rewards">
                <h5>Настройка наград</h5>
            ...
            <!-- Оформление -->
            <div class="settings-tab" id="tab-display">
                <h5>Оформление виджета</h5>
                <div class="form-check form-switch mb-3">
            ...
            <!-- Предпросмотр -->
            <div class="settings-tab" id="tab-preview">
                <h5>Предпросмотр</h5>
...
<style>
.daily-bonus-settings { width: 100%; }
.daily-bonus-settings .settings-layout {
    display: flex;
    gap: 0;
    min-height: 400px;
}
.daily-bonus-settings .settings-nav {
    min-width: 160px;
...
.daily-bonus-settings .settings-nav button {
    display: flex;
    align-items: center;
    gap: 10px;
    width: 100%;
...
.daily-bonus-settings .settings-nav button:hover { background: #e9ecef; }
.daily-bonus-settings .settings-nav button.active { background: #0d6efd; color: #fff; }
.daily-bonus-settings .settings-content {
    flex: 1;
    padding: 20px;
    background: #fff;
    border-radius: 0 8px 8px 0;
}
.daily-bonus-settings .settings-tab { display: none; }
.daily-bonus-settings .settings-tab.active { display: block; }
.daily-bonus-settings .settings-content h5 {
    font-size: 16px;
    font-weight: 600;
    color: #212529;
    padding-bottom: 10px;
